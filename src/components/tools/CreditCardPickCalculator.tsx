...
export default function CreditCardPickCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">신용카드 피킹률(혜택율) 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">월 총 결제금액 대비 할인·적립 혜택 금액을 계산하여 카드의 혜택 체감률(피킹률) 등급을 진단합니다.</p>
          </div>
        </div>
