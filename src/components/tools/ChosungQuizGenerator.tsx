...
export default function ChosungQuizGenerator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">초성 퀴즈 단어 생성기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">사자성어, 영화 제목, 음식, 수도 등 카테고리별 초성을 제시하고 정답을 맞히는 퀴즈 도구입니다.</p>
          </div>
        </div>
