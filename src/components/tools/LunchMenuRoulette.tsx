...
export default function LunchMenuRoulette() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">오늘 뭐 먹지? 점심 메뉴 룰렛</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">한식, 중식, 일식, 양식, 분식 등 결정 장애를 해결해 주는 회전판 점심 메뉴 추천 룰렛입니다.</p>
          </div>
        </div>
