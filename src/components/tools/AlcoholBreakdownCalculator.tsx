...
export default function AlcoholBreakdownCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">음주 후 알코올 분해 시간 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">위드마크(Widmark) 공식을 기반으로 주종, 음주량, 체중에 따른 혈중 알코올 농도와 완전 분해 소요 시간을 모의 계산합니다.</p>
          </div>
        </div>
