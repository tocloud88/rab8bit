...
export default function BabyMonthsCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">아기 개월수 &amp; 예방접종 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">아기 생년월일을 입력하면 오늘 기준 만 나이, 개월수, 일수와 국가 필수 예방접종 추천 시기를 안내합니다.</p>
          </div>
        </div>
