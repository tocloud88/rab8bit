    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">영문 대소문자 &amp; 케이스 변환기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">UPPERCASE, lowercase, camelCase, snake_case, PascalCase, kebab-case로 텍스트를 즉시 변환합니다.</p>
          </div>
        </div>
