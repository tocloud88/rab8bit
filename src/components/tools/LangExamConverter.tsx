...
export default function LangExamConverter() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">어학 시험 점수 환산기 (토익/오픽/토스)</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">TOEIC, OPIc, 토익스피킹, TOEFL, TEPS 점수 간의 상관 환산 등급표를 확인합니다.</p>
          </div>
        </div>
