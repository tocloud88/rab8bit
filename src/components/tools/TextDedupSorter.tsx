...
export default function TextDedupSorter() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">텍스트 중복 줄 제거 &amp; 가나다 정렬기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">대량의 텍스트 줄바꿈 목록에서 중복된 줄을 제거하고 가나다/알파벳 순서로 오름차순/내림차순 정렬합니다.</p>
          </div>
        </div>
