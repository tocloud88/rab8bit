...
export default function MilitaryDdayCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">군 복무일수 &amp; 전역일 D-Day 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">입대일과 군별(육군, 해군, 공군, 해병대, 사회복무요원)을 선택하면 전역일과 복무 달성률(%)을 계산합니다.</p>
          </div>
        </div>
