...
export default function QuitSmokingCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">금연 일수 &amp; 절약액 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">금연 시작일과 하루 흡연량을 입력하면 아낀 담뱃값, 연장된 예상 수명, 신체 회복 마일스톤을 실시간 집계합니다.</p>
          </div>
        </div>
