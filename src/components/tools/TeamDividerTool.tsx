...
export default function TeamDividerTool() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">랜덤 팀/조 나누기 추첨기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">참가자 명단을 입력하고 원하는 팀 수나 인원수를 설정하면 공평하게 무작위 팀을 편성합니다.</p>
          </div>
        </div>
