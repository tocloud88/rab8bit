...
export default function PartyPenaltyWheel() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">술자리 벌칙 &amp; 미션 뽑기 룰렛</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">회식, MT, 파티에서 분위기를 띄우는 재미있는 벌칙과 미션을 무작위로 추첨합니다.</p>
          </div>
        </div>
