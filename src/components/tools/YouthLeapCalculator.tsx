...
export default function YouthLeapCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">청년도약계좌 만기 수령액 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">매월 납입액과 정부 기여금 매칭, 비과세 혜택을 합산하여 5년 만기 시 최종 수령액을 계산합니다.</p>
          </div>
        </div>
