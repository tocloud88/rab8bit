...
export default function HangulRomanizerTool() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">한국어 로마자 표기법 변환기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">국어의 로마자 표기법(문화체육관광부 고시) 표준에 맞춰 한글 이름, 도로명, 지명을 영문 표기로 변환합니다.</p>
          </div>
        </div>
