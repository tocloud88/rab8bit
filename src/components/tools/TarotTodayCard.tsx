...
export default function TarotTodayCard() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">오늘의 타로 카드 1장 운세</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">78장의 타로 카드 중 1장을 직접 뽑아 오늘 하루의 흐름, 마음가짐, 조언을 확인합니다.</p>
          </div>
        </div>
