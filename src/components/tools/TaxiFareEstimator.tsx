...
export default function TaxiFareEstimator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">택시 심야할증 &amp; 예상 요금 계산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">이동 거리와 시간대(주간/심야할증 20%~40%)를 고려하여 전국 주요 도시의 택시 요금을 추산합니다.</p>
          </div>
        </div>
