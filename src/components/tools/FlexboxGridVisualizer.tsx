...
export default function FlexboxGridVisualizer() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">CSS Flexbox &amp; Grid 인터랙티브 시각화</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">justify-content, align-items, flex-direction 등 Flex/Grid 속성을 슬라이더로 조작하며 동작 원리를 배웁니다.</p>
          </div>
        </div>
