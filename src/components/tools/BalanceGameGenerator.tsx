...
export default function BalanceGameGenerator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">밸런스 게임 질문 생성기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">연애, 직장, 황당, 극단적 선택 등 모임에서 즐길 수 있는 재미있는 밸런스 게임 문항을 랜덤 제시합니다.</p>
          </div>
        </div>
