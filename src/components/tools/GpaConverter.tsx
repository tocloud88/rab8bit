    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">대학교 학점 변환기 (4.5/4.3/100점)</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">4.5 만점, 4.3 만점, 4.0 만점 학점을 백분율(100점) 점수로 상호 환산하여 취업 및 대학원 제출용 점수를 산출합니다.</p>
          </div>
        </div>
