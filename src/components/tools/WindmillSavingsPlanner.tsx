...
export default function WindmillSavingsPlanner() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">적금 풍차돌리기 플래너</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">매월 1년 만기 적금을 새로 개설하여 1년 후부터 매월 원금과 이자를 수령하는 적금 계획을 시뮬레이션합니다.</p>
          </div>
        </div>
