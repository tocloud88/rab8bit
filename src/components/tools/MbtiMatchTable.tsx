...
export default function MbtiMatchTable() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">MBTI 16가지 성격 유형 궁합표</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">나의 MBTI와 상대방의 MBTI를 선택하여 환상의 궁합, 반반 궁합, 주의할 점을 확인합니다.</p>
          </div>
        </div>
