...
export default function TravelExpenseCalculator() {
    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">출장비 &amp; 유류비 실비 정산기</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">국내외 출장 시 이동 거리당 유류비, 일비, 숙박비, 식비를 항목별로 취합하여 정산 보고서를 생성합니다.</p>
          </div>
        </div>
