    ...
    <div className="space-y-6 max-w-2xl mx-auto">
      <div className="stitch-card p-5 sm:p-7 rounded-3xl space-y-6 border border-indigo-500/25 shadow-2xl backdrop-blur-xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-800">
          ...
          <div>
            <h2 className="text-lg sm:text-xl font-black text-white tracking-tight">웹 컬러 코드(HEX/RGB/HSL) 추출 &amp; 팔레트</h2>
            <p className="text-xs sm:text-sm text-slate-400 mt-0.5">컬러 피커에서 색상을 선택하여 HEX, RGB, HSL 코드를 확인하고 조화로운 5색 테마 팔레트를 생성합니다.</p>
          </div>
        </div>
